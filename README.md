# Debate multi-agente con AutoGen + Groq
...
> 💡 Si nunca usaste AutoGen, empezá por [docs/conceptos.md](docs/conceptos.md) y después volvé acá.
...
- Si el moderador alterna siempre investigador ↔ crítico, **no significa que sea round-robin**:
  ...
  [ejercicio 2](docs/ejercicios.md#ejercicio-2--forzar-una-decisión-no-alternada) para verlo elegir distinto.
...
├── pyproject.toml           # dependencias (Poetry) y fuente del mirror interno
...
└── docs/
    ...
    ├── groq.md                  # cómo se conecta AutoGen con Groq
    ├── ejercicios.md            # prácticas guiadas para modificar el proyecto
    └── problemas-frecuentes.md  # errores reales y cómo resolverlos
```
...
Ejemplo: `MAX_TURNS=8 poetry run python debate_groupchat.py`
...
👉 Para solucionar la primera limitación, hacé el [ejercicio 5](docs/ejercicios.md#ejercicio-5--darle-una-herramienta-al-investigador).

## 📚 Para seguir aprendiendo

- [docs/conceptos.md](docs/conceptos.md): la teoría detrás del group chat.
- [docs/ejercicios.md](docs/ejercicios.md): prácticas de dificultad creciente.
